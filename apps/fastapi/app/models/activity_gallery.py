...
from sqlalchemy import BigInteger, Boolean, Column, Date, DateTime, ForeignKey, Integer, LargeBinary, String
...
class ActivityGallery(Base):
    ...
    gallery_name = Column(NVARCHAR(255), nullable=False)
    gallery_type = Column(String(20), nullable=False)
    description = Column(NVARCHAR(length=None), nullable=True)
...
class ActivityGalleryMedia(Base):
    ...
    original_file_name = Column(NVARCHAR(255), nullable=True)
