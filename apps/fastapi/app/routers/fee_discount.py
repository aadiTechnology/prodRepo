...
def create_discount(
    ...
    fee_discount_service.create_discount(db, tenant_id, data)
...
def list_discounts(
    ...
    print("DEBUG ORM RESPONSE:", response_data)
    return {
        "data": response_data,
        "total": total
    }
...
def update_discount(
    ...
    fee_discount_service.update_discount(db, tenant_id, discount_id, data)
